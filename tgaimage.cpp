...
TGAColor::TGAColor(const std::uint8_t data1, const std::uint8_t data2, const std::uint8_t data3, const std::uint8_t data4)
{
    bgra[0] = data3;
    bgra[1] = data2;
    bgra[2] = data1;
...
TGAColor::TGAColor(const std::uint8_t data1, const std::uint8_t data2, const std::uint8_t data3, const std::uint8_t data4, const std::uint8_t _bytespp)
{
    bgra[0] = data3;
    bgra[1] = data2;
    bgra[2] = data1;
...
TGAColor& TGAColor::operator * (float t)
{
    for(int i=0;i<3;i++)
    {
...
std::ostream& operator<<(std::ostream& s, const TGAColor& color)
{
    s << (int)color.bgra[2] << " " << (int)color.bgra[1] << " " << (int)color.bgra[0] << " " << (int)color.bgra[3] << "\n";
    return s;
}
